...
<main class="container">
        ...
        <c:forEach var="i" items="${videoList}">
            <div class="card" style="width:400px">
                ...
                <div class="card-body">
                    ...
                    <div class="float-end">
                        <c:if test="${i.like}">
                            <a href="/user/trangChuUnlike/?videoId=${i.id}&page=${currentPage}" class="btn btn-primary">Unlike</a>
                        </c:if>

                        <c:if test="${!i.like}">
                            <a href="/user/trangChuLike/?videoId=${i.id}&page=${currentPage}" class="btn btn-primary">Like</a>
                        </c:if>
                        <a href="/user/showChiaSe/?videoId=${i.id}&page=${currentPage}" class="btn btn-primary">Share</a>
                    </div>
                </div>
            </div>
        </c:forEach>
    ...
    <ul class="pagination justify-content-center my-5">
        <li class="page-item"><a class="page-link" href="/showTrangChu/?page=1">First</a></li>
        <c:forEach  begin="1" end="${totalPage}" var="i">
            <li class="page-item"><a class="page-link" href="/showTrangChu/?page=${i}">${i}</a></li>
        </c:forEach>

        <li class="page-item"><a class="page-link" href="/showTrangChu/?page=${totalPage}">Last</a></li>
    </ul>
</main>

...
<main class="container">
    <h2 class="text-center">QUAN LY NGUOI SU DUNG</h2>
    <div class="">
        <form class="row"  method="post">
            <div class="col-6">
                <div class="my-3">
                    <label class="form-label">USERNAME</label>
                    <input class="form-control" type="text" name="id" value="${userEdit.id}" ${isIdEnable}>
                    <p class="fw-bold text-danger">${idError}</p>
                </div>
                <div class="my-3">
                    <label class="form-label">FULLNAME</label>
                    <input class="form-control" type="text" name="fullname" value="${userEdit.fullname}">
            ...
            <div class="col-6">
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="password" value="${userEdit.password}">
                    <p class="fw-bold text-danger">${passwordError}</p>
                </div>
                <div class="my-3">
                    <label class="form-label">EMAIL ADDRESS</label>
                    <input class="form-control" type="text" name="email" value="${userEdit.email}">
            ...
            <div class="my-5 text-end" style="margin: 0px; padding: 0px;">
                <hr>
                <button class="btn btn-primary px-4" formaction="/admin/userUpdate/?page=${currentPage}" ${isUpdateable}>Update</button>
                <button class="btn btn-primary px-4" formaction="/admin/userDelete/?page=${currentPage}" ${isDeleteable}>Delete</button>
            </div>
        </form>
        ...
        <table class="table table-striped table-bordered text-center">
            ...
            <c:forEach var="i" items="${userList}">
                <tr>
                    ...
                    <td><a class="btn btn-primary px-5" href="/admin/userEdit/?userId=${i.id}&page=${currentPage}">Edit</a></td>
                </tr>
            </c:forEach>
    ...
    <ul class="pagination justify-content-center my-5">
        <li class="page-item"><a class="page-link" href="/admin/showUsers/?page=1">Frist</a></li>
        <c:forEach begin="1" end="${totalPage}" var="i" >
            <li class="page-item"><a class="page-link" href="/admin/showUsers/?page=${i}">${i}</a></li>
        </c:forEach>
        <li class="page-item"><a class="page-link" href="/admin/showUsers/?page=${totalPage}">Last</a></li>
    </ul>
</main>

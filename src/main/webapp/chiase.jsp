...
<main class="container">
  <div class="row border border-4 m-5 p-5 text-center" >
    <h3>Send video to your friend</h3>
    <form action="/user/share" method="post">
      <label >YOUR FRIEND'S EMAIL</label><br>
      <input type="text" placeholder="Your friend email" style="width: 500px;" name="email">
      <input type="hidden" style="width: 500px;" name="videoId" value="${videoId}">
      <br>
      <br>
      <button class="py-2 px-5">Send</button>
    </form>
  </div>
</main>
